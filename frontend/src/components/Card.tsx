...
const Card = ({ name, pic }: CardProps) => {
  ...
  return (
    <div className="flex flex-col items-center p-4 rounded-xl group hover:bg-[#ffffff23] hover:z-0 ease-in-out w-full md:w-[300px] transition-transform duration-300 hover:scale-105">
